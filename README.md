...
|:--:| 
| *Visualization of the 'Matthews-1.graphml diagram'. Schematization of the fracture of an industrial fan main shaft, taken from "A Practical Guide to Engineering Failure Investigation", Matthews Clifford, 1998.* |

| ![Matthews-model-1-v8](https://github.com/user-attachments/assets/810ab72f-88a4-47f0-ac7d-afe28a9df67c)
 |
|:--:| 
| *Visualization of the 'Matthews-2.graphml diagram'. Another conceptualization of the same failure event* |
